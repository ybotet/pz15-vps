...
- RestartSec=5 — задержка в 5 секунд перед попыткой перезапуска, предотвращая бесконечный цикл быстрых перезапусков
=======
# Практическое занятие №15: Деплой приложения на VPS. Настройка systemd
...
 
>>>>>>> e73edd1d63fd267b11625e8f61510419ed3b94c7
